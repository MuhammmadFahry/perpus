...
@section('content')
    ...
    <x-form class="card">
        ...
        <div class="input-group">
            <x-input-name class="form-control" placeholder="Enter your full name"></x-input-name>
        </div>
        @error('name')
        ...
        <div class="input-group">
            <x-input-password class="form-control" placeholder="Confirm your password">
